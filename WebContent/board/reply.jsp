...
<body>
	<h1>답변</h1>
	<form action="reply_pro.do" id = "writeForm" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
		<input type="hidden" name="ref" value="${parentBoard.ref}">
        <input type="hidden" name="step" value="${parentBoard.step}">
		...
		<tr>
			...
			<td>		
				<input type="text" name="title" value="RE : ${parentBoard.title}">
			</td> 
		</tr>
		<tr>
			<th>
