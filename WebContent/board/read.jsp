	...
	<div class="container">
		...
		<form>
			...
			<div class="text-center">
				<button type="button" class="btn btn-primary" onclick="location.href='reply.do?seq=${read.seq}'">답변</button>
				<button type="button" class="btn btn-warning" onclick="location.href='modify.do?seq=${read.seq}'">수정</button>
				<button type="button" class="btn btn-danger" onclick="location.href='delete.do?seq=${read.seq}'">삭제</button>
