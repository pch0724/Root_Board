...
<body>
	...
	<table id = "boardtable" width="500" border="1" cellpadding="0" cellspacing="0" align="center">
			<tr>
	...
	<form action="list.do" id = "search" name="search" method="get" accept-charset="UTF-8">
		<table width="500" align="center">
			<tr>
